...
export class PdfReadonlyEditorProvider implements vscode.CustomReadonlyEditorProvider<PdfDocument> {
  ...
  public async resolveCustomEditor(
    ...
    const panelStateSubscription = webviewPanel.onDidChangeViewState(
      (event) => {
  ...
  public async openDocumentAtPage(
    uri: vscode.Uri,
    page: number,
  ): Promise<void> {
